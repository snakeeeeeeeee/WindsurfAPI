...
const BUSINESS_ENV_KEYS = [
  ...
  'WINDSURFAPI_ANTHROPIC_REPORTED_CACHE_TARGET_HIT_RATE',
  'WINDSURFAPI_ANTHROPIC_REPORTED_CACHE_TARGET_WRITE_FLOOR',
  'WINDSURFAPI_ANTHROPIC_REPORTED_CACHE_TARGET_INPUT_FLOOR',
...
describe('runtime-config SQLite defaults', () => {
  it('imports availability and business env defaults into an empty database', async () => {
    ...
    assert.equal(runtime.getBusinessEnvConfig().CASCADE_DISABLE_HISTORY_TRIM, '1');
  ...
  it('persists dashboard-style business env updates and clears removed keys from process env', async () => {
    ...
    runtime.setBusinessEnvConfig({
      ...
      WINDSURFAPI_ANTHROPIC_REPORTED_CACHE_TARGET_HIT_RATE: '0.90',
      WINDSURFAPI_ANTHROPIC_REPORTED_CACHE_TARGET_WRITE_FLOOR: '1',
      WINDSURFAPI_ANTHROPIC_REPORTED_CACHE_TARGET_INPUT_FLOOR: '1',
      ...
      CASCADE_DISABLE_HISTORY_TRIM: '1',
    ...
    assert.equal(process.env.WINDSURFAPI_ANTHROPIC_REPORTED_CACHE_TARGET_HIT_RATE, '0.90');
    assert.equal(process.env.WINDSURFAPI_ANTHROPIC_REPORTED_CACHE_TARGET_WRITE_FLOOR, '1');
    assert.equal(process.env.WINDSURFAPI_ANTHROPIC_REPORTED_CACHE_TARGET_INPUT_FLOOR, '1');
    ...
    assert.equal(process.env.CASCADE_DISABLE_HISTORY_TRIM, '1');
    ...
    assert.equal(runtime.getBusinessEnvConfig().WINDSURFAPI_ANTHROPIC_REPORTED_CACHE_TARGET_HIT_RATE, undefined);
    assert.equal(runtime.getBusinessEnvConfig().WINDSURFAPI_ANTHROPIC_REPORTED_CACHE_TARGET_WRITE_FLOOR, undefined);
    assert.equal(runtime.getBusinessEnvConfig().WINDSURFAPI_ANTHROPIC_REPORTED_CACHE_TARGET_INPUT_FLOOR, undefined);
    ...
    assert.equal(runtime.getBusinessEnvConfig().CASCADE_DISABLE_HISTORY_TRIM, undefined);
    ...
    assert.equal(process.env.WINDSURFAPI_ANTHROPIC_REPORTED_CACHE_TARGET_HIT_RATE, undefined);
    assert.equal(process.env.WINDSURFAPI_ANTHROPIC_REPORTED_CACHE_TARGET_WRITE_FLOOR, undefined);
    assert.equal(process.env.WINDSURFAPI_ANTHROPIC_REPORTED_CACHE_TARGET_INPUT_FLOOR, undefined);
    ...
    assert.equal(process.env.CASCADE_DISABLE_HISTORY_TRIM, undefined);
